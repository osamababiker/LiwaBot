    ...
    <div className='bg-white'>
      ...
      <div className='relative isolate pt-14'>
        <div
          ...
          aria-hidden='true'>
          <div
            className='relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#3D3D5F] to-[#3D3D5F] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]'
            style={{
              clipPath:
          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl text-center'>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-600'>
                Our chatbot, designed with cutting-edge AI technology, serves as a reliable and accessible resource for students,
